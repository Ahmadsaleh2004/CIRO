...
<nav class="navbar custom-navbar sticky-top navbar-expand-lg" id="mainNavbar">
    <div class="container-fluid px-3">
        <a class="navbar-brand fw-bold" href="/Task(1)/admin/dashboard.php">
            🏪 Cairo Store
        ...
        <div class="collapse navbar-collapse" id="adminNav">
            <ul class="navbar-nav mx-auto gap-1">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/Task(1)/pages/products.php">🛍️ Products</a>
                </li>
                <?php endif; ?>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/Task(1)/index.php" target="_blank">🌐 Store</a>
                </li>
            </ul>
